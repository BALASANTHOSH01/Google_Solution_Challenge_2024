...
const AwardSection = () => {
    return (
        <div>
            <div>
                <div className=" flex mt-[5%]  flex-row items-start gap-6 ml-[5%] border border-gray-400 p-3 rounded-[10px] w-[40%]">
                    ...
                    <div className="flex flex-col gap-2 items-center">
                        ...
                        <div className=" px-5 py-[6px] w-[100%] text-center cursor-pointer bg-green-500 text-white font-medium rounded-[25px] ">
                            <p>Read More</p>
                        </div>
                    </div>
                </div>
