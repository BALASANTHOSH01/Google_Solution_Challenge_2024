                ...
                <div className="flex flex-row text-black font-semibold justify-around w-[100%] sm:text-[16px]">
                    ...
                    {/* {
                        contentselect === "clients" ?
                            <h1 onClick={() => setContentSelect("clients")} className="cursor-pointer font-bold" >Clients<hr className="w-[100%] bg-green-500 h-[2px] " /></h1>
                            :
...

                    {
                        contentselect === "awards" ?
                            <h1 onClick={() => setContentSelect("awards")} className="cursor-pointer font-bold">Awards<hr className="w-[100%] bg-green-500 h-[2px] " /></h1>
                            :
...

                    {
                        contentselect === "completed" ?
                            <h1 onClick={() => setContentSelect("completed")} className="cursor-pointer font-bold">Completed<hr className="w-[100%] bg-green-500 h-[2px] " /></h1>
                            :
