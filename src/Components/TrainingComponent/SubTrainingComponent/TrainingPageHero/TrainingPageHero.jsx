...
import ManWriting from "../../../../assets/Images/Training/TrainingSteps/ManWriting.jpg";
  ...
  return (
    <div className="mb-[5%]">
      <div className="flex flex-row sm:flex-col justify-around gap-3 w-[100%] font-Manrope">
        ...
        <div className="w-[60%] sm:w-[90%] mx-auto sm:my-[5%] ml-[5%]">

          <div className="flex flex-row gap-3 items-center">
            <h1 className="text-[35px] text-green-600 font-semibold">Green Harbor</h1>
            <p className="text-white py-1 px-2 rounded-[5px] font-semibold bg-green-600 tracking-wider">PLUS</p>
          </div>
