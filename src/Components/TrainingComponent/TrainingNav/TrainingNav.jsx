...
const TrainingNav = () => {
    ...
    return (
        <div>
            <div className="fixed left-0 top-[calc(100vh-90vh)] sm:top-[86%] bg-white z-20 sm:w-[100%] sm:bottom-0 flex flex-col sm:flex-row justify-around h-[60vh] sm:h-[15vh] mt-[2%] p-2">
