    ...
    return (
        <div className="flex flex-row justify-between p-2 my-2">
            ...
            <Link to={'/'} className="ml-[5%]">
                <div className="block box-border justify-center items-center p-3 sm:p-2 rounded-[50%] bg-gray-200 hover:bg-green-500 hover:text-white sm:hover:bg-green-500   sm:bg-transparent cursor-pointer sm:text-[18px]">
                    <FaArrowLeftLong />
                </div>
            </Link>
